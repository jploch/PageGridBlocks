...
<div pg-children="pg_image pg_video pg_editor pg_group" pg-children-tab="append" pg-children-label="Slides" pg-wrapper>
    <div class="glide" data-autoplay="<?= $page->pg_slider_autoplay ?>" data-per-view="<?= $page->pg_slider_per_view ?>" data-per-view-mobile="<?= $page->pg_slider_per_view_mobile ?>" data-gap="<?= $page->pg_slider_gap ?>" data-hide-arrows="<?= $arrows === 'hide' ? '1' : '0' ?>" data-arrow-position="<?= $arrows ?>" data-hide-bullets="<?= $bullets === 'hide' ? '1' : '0' ?>" data-bullet-position="<?= $bullets ?>" data-animation="<?= $page->pg_slider_animation ? $page->pg_slider_animation->value : 'slide' ?>" data-animation-duration="<?= $page->pg_slider_animation_duration ?>" data-theme="<?= $page->pg_slider_theme ? $page->pg_slider_theme->value : 'dark' ?>" data-rewind="<?= $page->pg_slider_rewind ? '0' : '1' ?>" data-crop-media="<?= $page->pg_slider_crop_media ? '1' : '0' ?>">
